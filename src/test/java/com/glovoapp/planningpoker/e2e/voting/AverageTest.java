...
class AverageTest {
    ...
    private final String sessionName = "TEST222";
    private final String userName1 = "michal";
    private final String userName2 = "pawel";
    private final String expectedResult = "Average: 5";
    ...
    @Test
    void afterVotingFor2And8_TheAverageResultShouldBe5() {
...
// ------------------------- SecondUser ----------------------
        ...
        secondUserSessionPage.averageEqualsExpectedResult(driver2, expectedResult);
    }
}
